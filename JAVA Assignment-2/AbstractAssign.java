	...
	class PaymentTester {
		public static void main(String[] args) 
		{
			DebitCardPayment debitCardPayment1 = new DebitCardPayment(101);
			 ...
			 DebitCardPayment[] debitCardPayments = {debitCardPayment1, debitCardPayment2,
			debitCardPayment3};
			...
			debitCardPayments[i].getServiceTaxPercentage());
			 System.out.println("Discount percentage: " +
			debitCardPayments[i].getDiscountPercentage());
			 ...
			 CreditCardPayment[] creditCardPayments = {creditCardPayment1, creditCardPayment2,
			creditCardPayment3};
			 ...
			 System.out.println("Service tax percentage: " + 
			creditCardPayments[i].getServiceTaxPercentage());
